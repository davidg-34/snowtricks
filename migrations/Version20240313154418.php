 ...
 */
final class Version20240313154418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medias CHANGE type type VARCHAR(10) NOT NULL, CHANGE tricks_id tricks_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE tricks DROP medias_id, CHANGE created_at created_at DATETIME NOT NULL, CHANGE updated_at updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medias CHANGE tricks_id tricks_id INT NOT NULL, CHANGE type type VARCHAR(120) NOT NULL');
        $this->addSql('ALTER TABLE tricks ADD medias_id INT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
