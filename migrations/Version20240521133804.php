 ...
 */
final class Version20240521133804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medias DROP photo_une');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medias ADD photo_une VARCHAR(255) NOT NULL');
